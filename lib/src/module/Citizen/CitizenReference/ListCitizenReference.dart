...
class ListCitizenReferenceModule extends StatefulWidget {
  ListCitizenReferenceModule({Key key}) : super(key: key);

  @override
  _ListCitizenReferenceModuleState createState() => _ListCitizenReferenceModuleState();
}

class _ListCitizenReferenceModuleState extends State<ListCitizenReferenceModule> {
 final generic = new Generic();
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      appBar: AppBar(
        title: Text("Listado de referencias"),
      ),
        body: Column(
        ...
        children: <Widget>[
          Container(
            child: Padding(
                ...
                child: Text('Lista de referencias')),
          ),
          Card(
            elevation: 4,
            shape:
