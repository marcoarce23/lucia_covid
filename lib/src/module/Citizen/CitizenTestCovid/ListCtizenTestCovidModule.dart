...
class ListCitizenTestCovidModule extends StatefulWidget {
  @override
  _ListCitizenTestCovidModuleState createState() => _ListCitizenTestCovidModuleState();
}

class _ListCitizenTestCovidModuleState extends State<ListCitizenTestCovidModule> {
 final generic = new Generic();
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      appBar: AppBar(
        title: Text("Solicitudes de Test Covid"),
      ),
        body: Column(
        ...
        children: <Widget>[
          Container(
            child: Padding(
                ...
                child: Text('Lista de Test Covid')),
          ),
          Card(
            elevation: 4,
            shape:
