...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.MiPerfil,
        labelName: 'Mi Perfil',        
        icon: Icon(Icons.account_circle),
      ),
      DrawerList(
        index: DrawerIndex.BotonDePanico,
        labelName: 'Botón de pánico',
        icon: Icon(Icons.hearing),
      ),
      DrawerList(
        index: DrawerIndex.Institucion,
        labelName: 'Institución',
        icon: Icon(Icons.business),
      ),
      DrawerList(
        index: DrawerIndex.Noticias,
        labelName: 'Noticias',
        icon: Icon(Icons.question_answer),
      ),
      DrawerList(
        index: DrawerIndex.TestCovid,
        labelName: 'Test COVID',
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child:  Image(image: NetworkImage(prefs.avatarImagen)) ,
                            ),
                          ),
                        ),
                      );
